...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initScreen(int parentWidth, int parentHeight, MotionKeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            ...
            this.x = (float) ((int) (motionKeyPosition.mPercentX * ((float) parentWidth2)));
            int i = parentWidth2;
        } else {
            int i2 = parentWidth;
        }
    ...
    public void getCenter(double p, int[] toUse, double[] data, float[] point, double[] vdata, float[] velocity) {
        ...
        if (this.mRelativeToController != null) {
            ...
            float v_x3 = (float) ((d + (((double) rx2) * Math.sin((double) angle2))) - ((double) (v_width / 2.0f)));
            float f10 = ry2;
            double sin = ((double) v_x2) + (((double) dradius2) * Math.sin((double) angle2));
    ...
    public void setView(float position2, MotionWidget view, int[] toUse, double[] data, double[] slope, double[] cycle) {
        ...
        if (this.mRelativeToController != null) {
            ...
            if (!Float.isNaN(path_rotate3)) {
                ...
                float f10 = rx2;
                motionWidget = view;
                motionWidget.setRotationZ((float) (((double) path_rotate) + Math.toDegrees(Math.atan2((double) dv_y4, (double) dv_x2))));
            } else {
                v_y2 = v_y6;
                dv_y = dv_y4;
                float f11 = rx2;
            ...
            float path_rotate5 = path_rotate2;
            float dv_height5 = dv_height4;
            double[] dArr3 = dArr;
            if (!Float.isNaN(path_rotate5)) {
                float f13 = path_rotate5;
                motionWidget.setRotationZ((float) (((double) 0.0f) + ((double) path_rotate5) + Math.toDegrees(Math.atan2((double) (dv_y5 + (dv_height5 / 2.0f)), (double) (dv_x3 + (dv_width3 / 2.0f))))));
            }
            float f14 = dv_y5;
            v_y = v_y7;
            float f15 = dv_x3;
