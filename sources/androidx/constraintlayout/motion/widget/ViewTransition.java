...
public class ViewTransition {
    ...
    static class Animate {
        ...
        public void mutateReverse() {
            ...
            boolean repaint = this.mMC.interpolate(this.mMC.mView, this.mInterpolator == null ? this.mPosition : this.mInterpolator.getInterpolation(this.mPosition), current, this.mCache);
            if (this.mPosition <= 0.0f) {
                if (this.mSetsTag != -1) {
    ...
    public /* synthetic */ void m9lambda$applyTransition$0$androidxconstraintlayoutmotionwidgetViewTransition(View[] views) {
        if (this.mSetsTag != -1) {
            for (View view : views) {
    ...
    public boolean checkTags(View view) {
        boolean set2 = this.mIfTagSet == -1 || view.getTag(this.mIfTagSet) != null;
