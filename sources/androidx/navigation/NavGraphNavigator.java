    ...
    private final void navigate(NavBackStackEntry entry, NavOptions navOptions, Navigator.Extras navigatorExtras) {
        ...
        if ((startId == 0 && startRoute == null) ? false : true) {
            ...
            if (startDestination != null) {
                this.navigatorProvider.getNavigator(startDestination.getNavigatorName()).navigate(CollectionsKt.listOf(getState().createBackStackEntry(startDestination, startDestination.addInDefaultArgs(args))), navOptions, navigatorExtras);
                return;
            }
