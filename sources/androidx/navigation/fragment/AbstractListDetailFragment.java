...
public abstract class AbstractListDetailFragment extends Fragment {
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View listPaneView = onCreateListPaneView(layoutInflater, slidingPaneLayout, bundle);
        if (!Intrinsics.areEqual((Object) listPaneView, (Object) slidingPaneLayout) && !Intrinsics.areEqual((Object) listPaneView.getParent(), (Object) slidingPaneLayout)) {
            slidingPaneLayout.addView(listPaneView);
        }
        Context context = inflater.getContext();
        Intrinsics.checkNotNullExpressionValue(context, "inflater.context");
        FragmentContainerView detailContainer = new FragmentContainerView(context);
        detailContainer.setId(R.id.sliding_pane_detail_container);
        SlidingPaneLayout.LayoutParams detailLayoutParams = new SlidingPaneLayout.LayoutParams(inflater.getContext().getResources().getDimensionPixelSize(R.dimen.sliding_pane_detail_pane_width), -1);
        detailLayoutParams.weight = 1.0f;
        ...
        if (existingNavHostFragment != null) {
            ...
            View view = listPaneView;
        } else {
            newNavHostFragment = onCreateDetailPaneNavHostFragment();
            FragmentManager $this$commit_u24default$iv = getChildFragmentManager();
            Intrinsics.checkNotNullExpressionValue($this$commit_u24default$iv, "childFragmentManager");
            FragmentTransaction $this$onCreateView_u24lambda_u246_u24lambda_u245 = $this$commit_u24default$iv.beginTransaction();
            ...
            View view2 = listPaneView;
            $this$onCreateView_u24lambda_u246_u24lambda_u245.add(R.id.sliding_pane_detail_container, (Fragment) newNavHostFragment);
        ...
        View $this$doOnLayout$iv = slidingPaneLayout;
        if (!ViewCompat.isLaidOut($this$doOnLayout$iv) || $this$doOnLayout$iv.isLayoutRequested()) {
            $this$doOnLayout$iv.addOnLayoutChangeListener(new AbstractListDetailFragment$onCreateView$$inlined$doOnLayout$1(this, slidingPaneLayout));
        } else {
            View view3 = $this$doOnLayout$iv;
            ...
            access$getOnBackPressedCallback$p.setEnabled(slidingPaneLayout.isSlideable() && slidingPaneLayout.isOpen());
        }
