...
public final class AppBarConfiguration {
    ...
    private AppBarConfiguration(Set<Integer> topLevelDestinations2, Openable openableLayout2, OnNavigateUpListener fallbackOnNavigateUpListener2) {
        this.topLevelDestinations = topLevelDestinations2;
        this.openableLayout = openableLayout2;
        this.fallbackOnNavigateUpListener = fallbackOnNavigateUpListener2;
    }
    ...
    public final boolean isTopLevelDestination(NavDestination destination) {
        ...
        do {
            ...
            NavDestination parent = it.next();
            if (this.topLevelDestinations.contains(Integer.valueOf(parent.getId()))) {
                if (!(parent instanceof NavGraph)) {
                    z = true;
                    continue;
                } else if (destination.getId() == NavGraph.Companion.findStartDestination((NavGraph) parent).getId()) {
                    z = true;
                    continue;
                } else {
                    continue;
    ...
    public static final class Builder {
        ...
        public Builder(NavGraph navGraph) {
            ...
            this.topLevelDestinations.add(Integer.valueOf(NavGraph.Companion.findStartDestination(navGraph).getId()));
        }
        ...
        public Builder(Menu topLevelMenu) {
            ...
            for (int index = 0; index < size; index++) {
                this.topLevelDestinations.add(Integer.valueOf(topLevelMenu.getItem(index).getItemId()));
            }
        }
        ...
        public final Builder setOpenableLayout(Openable openableLayout2) {
            this.openableLayout = openableLayout2;
            return this;
        }

        public final Builder setFallbackOnNavigateUpListener(OnNavigateUpListener fallbackOnNavigateUpListener2) {
            this.fallbackOnNavigateUpListener = fallbackOnNavigateUpListener2;
            return this;
        }
