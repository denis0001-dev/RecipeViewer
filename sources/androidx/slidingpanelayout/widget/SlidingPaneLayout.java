    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i3 < childCount) {
            ...
            if (child.getVisibility() == 8) {
                ...
                int childHeightSpec2 = child.getMeasuredHeight();
                if (childHeightSpec2 > layoutHeight) {
                    int i6 = childWidthSpec2;
                    if (heightMode2 == Integer.MIN_VALUE) {
                        layoutHeight = Math.min(childHeightSpec2, maxLayoutHeight);
                    } else if (heightMode2 == 0) {
                        layoutHeight = childHeightSpec2;
                    }
                }
        ...
        if (canSlide || weightSum > 0.0f) {
            ...
            while (i8 < childCount) {
                ...
                if (child2.getVisibility() != 8) {
                    ...
                    int childHeightSpec3 = measureChildHeight(child2, i2, getPaddingTop() + getPaddingBottom());
                    if (measuredWidth != newWidth) {
                        child2.measure(childWidthSpec, childHeightSpec3);
        ...
        if (splitViews2 == null || canSlide) {
            ...
            while (i13 < childCount) {
                ...
                if (child3.getVisibility() == 8) {
                    ...
                    splitViews = splitViews2;
                    int childHeightSpec4 = View.MeasureSpec.makeMeasureSpec(child3.getMeasuredHeight(), BasicMeasure.EXACTLY);
                    heightMode = heightMode2;
                    int childWidthSpec3 = View.MeasureSpec.makeMeasureSpec(splitView.width(), Integer.MIN_VALUE);
                    child3.measure(childWidthSpec3, childHeightSpec4);
                    ...
                    if ((child3.getMeasuredWidthAndState() & 16777216) == 1) {
                        ...
                        child3.measure(View.MeasureSpec.makeMeasureSpec(splitView.width(), BasicMeasure.EXACTLY), childHeightSpec4);
                    } else {
                        i = BasicMeasure.EXACTLY;
                    }
                    child3.measure(View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin3, i), childHeightSpec4);
                    if (i13 != 0) {
                        lp3.slideable = true;
                        canSlide = true;
        ...
        while (i < childCount2) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.slideable) {
                    ...
                    int i3 = paddingStart2;
                    this.mSlideOffset = ((float) pos) / ((float) this.mSlideRange);
                } else {
                    paddingStart = paddingStart3;
                    childCount = childCount2;
                    if (this.mCanSlide == 0 || this.mParallaxBy == 0) {
                        xStart = nextXStart;
                    } else {
