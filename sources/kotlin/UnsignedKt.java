...
public final class UnsignedKt {
    ...
    public static final int m535uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m279constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }
    ...
    public static final long m537ulongDivideeb3DHEI(long v1, long v2) {
        ...
        if (divisor < 0) {
            ...
            return ULong.m358constructorimpl(j);
        } else if (dividend >= 0) {
            return ULong.m358constructorimpl(dividend / divisor);
        } else {
            int i = 1;
            long quotient = ((dividend >>> 1) / divisor) << 1;
            if (Long.compare(ULong.m358constructorimpl(dividend - (quotient * divisor)) ^ Long.MIN_VALUE, ULong.m358constructorimpl(divisor) ^ Long.MIN_VALUE) < 0) {
                i = 0;
            }
            return ULong.m358constructorimpl(((long) i) + quotient);
        }
    }
    ...
    public static final long m538ulongRemaindereb3DHEI(long v1, long v2) {
        ...
        if (divisor < 0) {
            ...
            return ULong.m358constructorimpl(v1 - v2);
        } else if (dividend >= 0) {
            return ULong.m358constructorimpl(dividend % divisor);
        } else {
            long rem = dividend - ((((dividend >>> 1) / divisor) << 1) * divisor);
            if (Long.compare(ULong.m358constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m358constructorimpl(divisor) ^ Long.MIN_VALUE) >= 0) {
                j = divisor;
            }
            return ULong.m358constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= 2.147483647E9d) {
            return UInt.m279constructorimpl((int) v);
        }
        return UInt.m279constructorimpl(UInt.m279constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m279constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        if (v < 9.223372036854776E18d) {
            return ULong.m358constructorimpl((long) v);
        }
        return ULong.m358constructorimpl(ULong.m358constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
