...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    private ULongProgressionIterator(long first, long last, long step2) {
        ...
        this.hasNext = z;
        this.step = ULong.m358constructorimpl(step2);
        this.next = this.hasNext ? first : this.finalElement;
    }

    public /* bridge */ /* synthetic */ Object next() {
        return ULong.m352boximpl(m1426nextsVKNKU());
    }
    ...
    public long m1426nextsVKNKU() {
        long value = this.next;
        if (value != this.finalElement) {
            this.next = ULong.m358constructorimpl(this.next + this.step);
