...
public final class UStringsKt {
    ...
    public static final String m1488toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1490toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1489toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1487toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m252unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m331unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m331unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m279constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m196boximpl(UByte.m202constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m331unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m279constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m459boximpl(UShort.m465constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m279constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m279constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m279constructorimpl(UInt.m279constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, beforeAdding ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m273boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m358constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m358constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m358constructorimpl(ULong.m358constructorimpl(((long) UInt.m279constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m352boximpl(result);
    }
}
