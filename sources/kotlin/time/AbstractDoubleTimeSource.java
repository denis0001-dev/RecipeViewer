...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m1493minusLRDsOJo(long duration) {
            return ComparableTimeMark.DefaultImpls.m1511minusLRDsOJo(this, duration);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m1491elapsedNowUwyO8pc() {
            return Duration.m1551minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m1496plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1552plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m1494minusUwyO8pc(ComparableTimeMark other) {
            ...
            } else if (Duration.m1521equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1548isInfiniteimpl(this.offset)) {
                return Duration.Companion.m1618getZEROUwyO8pc();
            } else {
                long offsetDiff = Duration.m1551minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) other).timeSource) && Duration.m1521equalsimpl0(m1494minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m1618getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m1544hashCodeimpl(Duration.m1552plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m1565toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1618getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
