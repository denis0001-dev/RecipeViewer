...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public long m1649markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1661constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m1648elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark);
    }

    /* renamed from: differenceBetween-fRLX17w  reason: not valid java name */
    public final long m1647differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m1646adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1661constructorimpl(LongSaturatedMathKt.m1644saturatingAddpTJri5U(timeMark, duration));
    }
}
