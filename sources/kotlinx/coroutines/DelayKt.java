...
public final class DelayKt {
    ...
    public static final Object m1688delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1689toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1689toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1515compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.Companion.m1618getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1534getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1);
        }
        return 0;
    }
}
