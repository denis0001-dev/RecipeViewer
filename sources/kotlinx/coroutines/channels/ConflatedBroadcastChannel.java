...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> handler) {
        ...
        Object state = this._state;
        if ((state instanceof Closed) && AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(onCloseHandler$FU, this, handler, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object m1723trySendJP2dKIU(E element) {
        Closed it = offerInternal(element);
        if (it != null) {
            return ChannelResult.Companion.m1720closedJP2dKIU(it.getSendException());
        }
